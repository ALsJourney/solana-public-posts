    ...
    return (
        <div className={"flex flex-col items-center align-center"}>
            ...
            {initialized ? (
                ...
                <>
                    <h1 className={"text-2xl md:text-4xl font-bold"}>Successfully initialized ✅</h1>
                ...
                <>
                    <h1 className={"text-2xl md:text-4xl font-bold"}>We need to create a new user account first.</h1>
